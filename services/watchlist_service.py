...
def add_to_watchlist(user_id, film_id, public=True):
    ...
    Args:
        ...
        public (bool): Whether the entry is publicly visible. Defaults to True —
                       see the default-visibility decision in pr-response.md.
                       Callers can pass False to opt out explicitly.
...
def get_watchlist(user_id, sort="recent"):
    """
    ...
    Args:
        ...
        sort (str): Ordering of the results.
            "recent" (default) — by date added, newest first (matches
                                 get_collection and the reviewer's preference).
            "title"            — alphabetically by film title.
