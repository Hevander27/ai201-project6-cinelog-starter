...
def view_watchlist(user_id):
    """
    GET /watchlist/<user_id>?sort=recent|title

    Returns the user's watchlist. Defaults to date-added order (newest first);
    pass ?sort=title for alphabetical.
    """
    sort = request.args.get("sort", "recent")
    films = get_watchlist(user_id, sort=sort)
...
def add_film(user_id):
    ...
    Body: { "film_id": "<uuid>", "public": true }
      - public is optional and defaults to True.
    """
